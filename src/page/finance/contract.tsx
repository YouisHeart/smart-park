...
import { setData,setTotal } from "../../store/finance/contractSlice";
...
function Contract() {
    ...
    useEffect(()=>{
        // 如果从其他页面进来的，需要加载。如果redux中没有数据也需要加载
    ...
    return <div>
        <Card className="search">
            <Row gutter={16}>
                <Col span={7}>
                    <p>合同编号:</p>
                    <Input name="contractNo" value={formData.contractNo} onChange={handleChange}></Input>
                </Col>
                <Col span={7}>
                    <p>联系人：</p>
                ...
                <Col span={7}>
                    <p>联系电话：</p>
                    <Input name="tel" value={formData.tel} onChange={handleChange}></Input>
                </Col>
                <Col span={3}>
