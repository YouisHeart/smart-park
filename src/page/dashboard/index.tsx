        ...
        <Row gutter={16}>
            <Col span={6}>
                <Card className="clearfix">
                    ...
                    <div className="fr">
                         <RadarChartOutlined className="icon"></RadarChartOutlined>   
                    </div>
                </Card>
            </Col>
            <Col span={6}>
                 <Card className="clearfix">
                    ...
                    <div className="fr">
                         <SnippetsOutlined className="icon" style={{color: "#81c452"}}></SnippetsOutlined>   
                    </div>
                </Card>
            </Col>
            <Col span={6}>
                 <Card className="clearfix">
                    ...
                    <div className="fr"> 
                         <DollarOutlined className="icon" style={{color: "#62c9cb"}}></DollarOutlined>   
                    </div>
                </Card>
            </Col>
            <Col span={6}>
                <Card className="clearfix">
                    ...
                    <div className="fr">
                         <LaptopOutlined className="icon" style={{color: "#e49362"}}></LaptopOutlined>   
                    </div>
                </Card>
            </Col>
        </Row>
            ...
            <Col span={6}>
                <Card title="充电桩空闲统计">
                    <div className="wrap">    
                        ...
                        <Statistic title="总充电桩数" value={75} suffix="/ 100" className="mt"></Statistic>
                    </div>
                </Card>
            </Col>
            <Col span={6}>
                <Card title="实时车辆信息" style={{height: "405px"}}>
                    <Timeline items={[
                             {
